...
void checkMesh( std::vector<stl::triangle> &triangles )
{
    ...
    for ( unsigned int i = 0; i < triangles.size(); i++ )
    {
        ...
        Vector3 v1( triangles[i].v2.x - triangles[i].v1.x, triangles[i].v2.y - triangles[i].v1.y, triangles[i].v2.z - triangles[i].v1.z );

        Vector3 v2( triangles[i].v3.x - triangles[i].v2.x, triangles[i].v3.y - triangles[i].v2.y, triangles[i].v3.z - triangles[i].v2.z );

        Vector3 v3( triangles[i].v1.x - triangles[i].v3.x, triangles[i].v1.y - triangles[i].v3.y, triangles[i].v1.z - triangles[i].v3.z );
