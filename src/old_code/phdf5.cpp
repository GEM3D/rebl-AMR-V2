...
void Phdf5<N, Nvalue, M, Mvalue>::writePolyvertex( Forest<N, Nvalue, M, Mvalue> &F, uint appx )
{
...
template <size_t N, typename Nvalue, size_t M, typename Mvalue>
void Phdf5<N, Nvalue, M, Mvalue>::xdmfPolyvertex( integer myrank, uint appx )
{
...
template <size_t N, typename Nvalue, size_t M, typename Mvalue>
void Phdf5<N, Nvalue, M, Mvalue>::writeMultiBlock( Forest<N, Nvalue, M, Mvalue> &F, uint appx )
{
            ...
            for ( uint j = 0; j < L1; j++ )
            {
                for ( uint k = 0; k < M1; k++ )
                {
                    for ( uint l = 0; l < N1; l++ )
                    {
                           ...
                           qtemp[index] = com.myRank();
                       //     cout<< "rank in IO "<<qtemp[index]<<endl;
...
template <size_t N, typename Nvalue, size_t M, typename Mvalue>
void Phdf5
<N, Nvalue, M, Mvalue>::xdmfMultiBlock( Forest<N, Nvalue, M, Mvalue> &F, integer comsize, integer my_rank, uint offset, uint appx )
{
    MPI_File fp;
...
//template class Phdf5<32, real, 32, uint>;
//template class Phdf5<64, real, 64, uint>;

template class Phdf5<TREESIZE, real, PROCSIZE, uint>;
template class Phdf5<64, real, 3, uint>;
// template class Phdf5<64,real,3,real>;
template class Phdf5<64, real, 6, uint>;
template class Phdf5<64, real, 9, uint>;
